    ...
    >
      ...
      >
        <Label
          text="About"
          fontSize="20"
          class="w-full roboto-slab py-3 mt-3 purple"
        />
        <TextView
          fontSize="15"
          class="w-full gray mt-3"
          editable="false"
        >
          {{ about }}
        </TextView>
      ...
      <StackLayout
        orientation="vertical"
        class="px-3 mt-3 mb-5"
      >
        <Label
          text="Organizing Team"
          fontSize="22"
          class="w-full text-center roboto-slab py-3 mt-3 purple"
        />
        <FlexboxLayout
        ...
        >
          <StackLayout
            ...
            class="w-32 text-center mb-4"
          >
            <StackLayout class="p-3 bg-green-200 rounded-lg">
              <ImageCacheIt
                :src="member.photo"
                class="w-24 h-24 border-4 border-green-400 rounded-full"
            ...
            <Label
              ...
              fontSize="14"
              textWrap="true"
              class="w-32 gray font-bold mt-2"
            />
            <Label
              :text="member.tagline"
              fontSize="12"
