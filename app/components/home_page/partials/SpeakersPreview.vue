    ...
    >
      <StackLayout class="w-2/3">
        <Label
          text="Speakers"
          fontSize="20"
          class="w-full black font-bold roboto-slab text-left"
        />
      </StackLayout>
      <StackLayout
        orientation="horizontal"
      ...
      >
        <Label
          ...
          class="w-1/2 purple font-bold mr-2"
        />
        <Label
          :text="`+${speakers.length}`"
          fontSize="12"
          class="w-1/2 purple bg-purple-light-c text-center rounded-full px-3 py-0 h-6"
        />
      </StackLayout>
    </StackLayout>
    <ScrollView
    ...
    >
      ...
      >
        <StackLayout
          ...
          class="w-1/4 text-center mr-2"
          @tap="onSpeakerTap(speaker)"
        >
          <StackLayout class="p-3 bg-green-200 rounded-lg">
            <ImageCacheIt
              :src="speaker.avatar"
              class="w-20 h-20 border-4 border-green-400 rounded-full"
              verticalAlignment="center"
            />
          </StackLayout>
          <Label
            ...
            fontSize="12"
            textWrap="true"
            class="w-24 gray font-bold mt-2"
          />
        </StackLayout>
      </StackLayout>
    </ScrollView>
