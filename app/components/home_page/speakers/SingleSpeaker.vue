    ...
    <Page actionBarHidden="true">
        <ScrollView ref="scrollView" @scroll="onScroll">
            <StackLayout class="bg-ash-c">
                <StackLayout ref="topView" verticalAlignment="top" height="235" style="background-image: url('~/assets/images/Asset-1.png'); background-repeat: no-repeat; background-position: center; background-size: cover;" class="px-3 ">
                ...
                <StackLayout orientation="horizontal" class="w-full px-3" marginTop="-55">
                    ...
                    <StackLayout class="px-3 mt-5">
                        ...
                        <Label :text="speaker.tagline" fontSize="14" class="gray" textWrap="true" />
                        <StackLayout orientation="horizontal">
                            <Image src.decode="font://&#xf099;" width="16" class="fab green t-36 mr-2"></Image>
                            <Label :text="speaker.twitter.split('.com/').pop()" class="purple" fontSize="16" textWrap="true" />
                        </StackLayout>
                    </StackLayout>
                </StackLayout>
                <StackLayout width="100%" class="bg-ash-c px-3 py-4">
                    ...
                    <StackLayout>
                        ...
                        <Label textWrap="true" fontSize="15" class="gray" :text="speaker.biography"
                        />
                        <FlexboxLayout class="mt-16 mb-10">
                            <Label text="Twitter Handle" fontSize="16" class="purple pr-3" textWrap="true" />
                           <StackLayout>
                               <FlexboxLayout justifyContent="space-between" class="rounded-full px-3 py-1 bg-white-c" @tap="copy">
                                   <Label :text="'@' + speaker.twitter.split('.com/').pop()" fontSize="15" class="green pr-3" textWrap="true" />
...
export default {
    ...
    methods: {
        ...
        copy () {
            const vm = this
            clipboard.setText(this.speaker.twitter).then(function() {
                vm.$feedback.success({
                    title: "OK",
