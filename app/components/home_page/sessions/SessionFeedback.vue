<template>
    <Page actionBarHidden="true" class="bg-ash-c">
        ...
        <ScrollView ref="scrollView" @scroll="onScroll">
            <StackLayout>
                <StackLayout ref="topView" verticalAlignment="center" height="170"
                    ...
                    <FlexboxLayout justifyContent="space-between" verticalAlignment="center">
                        ...
                        <StackLayout orientation="vertical" horizontalAlignment="center">
                            ...
                            <Label text="Session Feedback" class="roboto-slab purple mt-3" fontSize="22"/>
                        </StackLayout>
                ...
                <StackLayout width="100%" class="bg-ash-c px-3 py-4">
                    <Label text="Kindly leave your honest feedback to help us make it even better. Cheers : )"
                           textWrap="true" fontSize="20" class="gray"/>
                    <TextView hint="Type here ..."
                              class="gray bg-white-c rounded-lg border-0 placeholder-gray-500 p-3 w-full mt-3"
                              fontSize="15"/>
                    <StackLayout orientation="vertical" horizontalAlignment="center" class="w-2/3 mt-10">
                        <Label text="Rating:" fontSize="16" class="gray text-center"/>
                        <StarRate emptyBorderColor="white" emptyColor="white" filledBorderColor="#707070"
                                  filledColor="#FFD54A" :value="2" :max="5" horizontalAlignment="center"
                                  verticalAlignment="center"></StarRate>

                        <Button fontSize="18" class="bg-purple-c white rounded-full mt-12" @tap="onButtonTap">
                            <FormattedString>
                                <Span text="Submit Feedback" class="white"/>
                                <Image src.decode="font://&#xf621;" class="fas t-36" width="10"></Image>
