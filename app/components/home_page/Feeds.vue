      ...
      <v-template>
        <StackLayout class="py-3">
          <StackLayout
            ...
            class="w-full bg-white-c rounded-lg px-3"
          >
            <Label
              :text="feed.body"
              class="gray"
            ...
            <FlexboxLayout justifyContent="space-between">
              ...
              >
                <Image
                  src.decode="font://&#xf017;"
                  class="fas t-36 gray-light mr-1"
                  width="15"
                />
                <Label
                  :text="humanReadable(feed.created_at) + ' - '+ hour(feed.created_at)"
                  fontSize="13"
                  class="font-bold gray-light uppercase"
                />
              </StackLayout>
              <StackLayout
                orientation="horizontal"
